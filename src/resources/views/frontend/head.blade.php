...
<head>
  ...
  <meta property="og:description" content="Web MP3 Player and Media Library management. Backend based on Laravel framework, client-side - mostly JavaScript" />
  <meta property="og:image"       content="{{ asset('assets/img/logo-lg.png') }}" />
